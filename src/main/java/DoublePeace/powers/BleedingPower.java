...
import DoublePeace.actions.LoseBleedingHPAction;
...
public class BleedingPower extends AbstractPower implements CloneablePowerInterface, HealthBarRenderPower {
    ...
    public static final String POWER_ID = DPMod.makeID("Bleeding");
    ...
    private static final Texture tex84 = TextureLoader.getTexture("DPResources/images/powers/Bleeding84.png");
    private static final Texture tex32 = TextureLoader.getTexture("DPResources/images/powers/Bleeding32.png");
